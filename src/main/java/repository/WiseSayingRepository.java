...
public class WiseSayingRepository {
    ...
    public int add(String message, String author) throws IOException {
        int no = id++;
        WiseSaying entity = new WiseSaying(no, message, author);
    ...
    public void edit(int no, String message, String author) throws IOException {
        File file = new File(resourcePath, no + ".json");
        om.writeValue(file, new WiseSaying(no, message, author));
    }
